...
import 'package:wanandroidflutter/generated/json/my_todo_data_entity.g.dart';
...
class MyTodoDataEntity {
  ...
  factory MyTodoDataEntity.fromJson(Map<String, dynamic> json) =>
      $MyTodoDataEntityFromJson(json);
...
class MyTodoDataItem {
  ...
  factory MyTodoDataItem.fromJson(Map<String, dynamic> json) =>
      $MyTodoDataDatasFromJson(json);
