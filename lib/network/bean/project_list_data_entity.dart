...
import 'package:wanandroidflutter/generated/json/project_list_data_entity.g.dart';
...
class ProjectListDataEntity {
  ...
  factory ProjectListDataEntity.fromJson(Map<String, dynamic> json) =>
      $ProjectListDataEntityFromJson(json);
...
class ProjectListDataItemEntity {
  ...
  factory ProjectListDataItemEntity.fromJson(Map<String, dynamic> json) =>
      $ProjectListDataDatasFromJson(json);
...
class ProjectListDataDatasTags {
  ...
  factory ProjectListDataDatasTags.fromJson(Map<String, dynamic> json) =>
      $ProjectListDataDatasTagsFromJson(json);
