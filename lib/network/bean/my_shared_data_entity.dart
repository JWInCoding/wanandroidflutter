...
import 'package:wanandroidflutter/generated/json/my_shared_data_entity.g.dart';
...
class MySharedDataEntity {
  ...
  factory MySharedDataEntity.fromJson(Map<String, dynamic> json) =>
      $MySharedDataEntityFromJson(json);
...
class MySharedDataCoinInfo {
  ...
  factory MySharedDataCoinInfo.fromJson(Map<String, dynamic> json) =>
      $MySharedDataCoinInfoFromJson(json);
...
class MySharedDataShareArticles {
  ...
  factory MySharedDataShareArticles.fromJson(Map<String, dynamic> json) =>
      $MySharedDataShareArticlesFromJson(json);
